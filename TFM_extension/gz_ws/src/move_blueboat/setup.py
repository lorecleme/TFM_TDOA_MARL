...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            # TDOA tracking integration
            'tdoa_observation_node = move_blueboat.tdoa_observation_node:main',
            'transf_qmix_inference_node = move_blueboat.transf_qmix_inference_node:main',
            'tdoa_action_mapper_node = move_blueboat.tdoa_action_mapper_node:main',
            'target_waypoint_controller = move_blueboat.target_waypoint_controller:main',
            'surround_metrics_node = move_blueboat.surround_metrics_node:main',
            'randomize_spawn = move_blueboat.randomize_spawn:main',
